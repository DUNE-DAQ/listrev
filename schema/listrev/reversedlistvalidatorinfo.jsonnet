...
local info = {
   ...
   info: s.record("Info", [
       ...
       s.field("total_reversed", self.uint8, 0, doc="Count of all reversed lists received"), 
       s.field("new_reversed", self.uint8, 0, doc="Count of new reversed lists received"), 
